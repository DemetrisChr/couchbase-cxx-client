...
public:
  ...
  void send_to(std::shared_ptr<io::http_session> session)
  {
    ...
    session_->write_and_stream(
      encoded_,
      [self = shared_from_this()](std::error_code ec, io::http_streaming_response resp) {
        if (ec == asio::error::operation_aborted) {
...
private:
  ...
  {
    auto ec =
      request_.is_idempotent ? errc::common::unambiguous_timeout : errc::common::ambiguous_timeout;
